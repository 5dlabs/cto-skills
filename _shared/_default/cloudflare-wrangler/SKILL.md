...
- **Set `compatibility_date`**: Use a recent date (within 30 days). Check [compatibility dates](https://developers.cloudflare.com/workers/configuration/compatibility-dates/)
